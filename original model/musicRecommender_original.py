...
def music_recommender(userPreferences):
        raw_data = pd.read_csv("../input training and test sets/original_training_set.csv", dtype={'track': 'str', 'artist': 'str'})
        ...
        training_data = raw_data.drop(['type', 'id', 'uri', 'track_href', 'analysis_url', 'track', 'artist'], axis=1, inplace=False)
